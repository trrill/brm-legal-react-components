...
function ProductItem({ product, layout, className }) {
	...
	return (
		<div className={`${className} product-item lg:text-center p-2 mb-2 lg:grayscale hover:grayscale-0 lg:rounded-lg lg:shadow-lg ${layout === 'grid' ? 'lg:w-1/4' : 'flex justify-between'}`} key={product.id} categories={categoriesReadable} customers={product.customers}>
